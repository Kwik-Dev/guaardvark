...
8. CRITICAL — IMAGE GENERATION: If the user asks you to draw, create, generate, or make an image/picture/photo, you MUST call generate_image with a <prompt> tag. Do NOT describe what the image would look like — CALL THE TOOL. You cannot produce images with text. NEVER fabricate image URLs or file paths.
